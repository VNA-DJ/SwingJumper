...
public class RopeControl : MonoBehaviour {
	...
	public float delayBeforeSecondHang = 1f;	//delay after jump before player will be able to hang on another rope
	...
	void Update ()
	{
		if(onRope)
		{
			...
			if(InputManager.GetAxis ("DPad0","Vertical") > 0 && chainIndex > 1)
			{
			...
			if(InputManager.GetAxis ("DPad0","Vertical") < 0)
			{
